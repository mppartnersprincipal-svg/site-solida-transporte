...
| `whatsapp_click` | Clique em QUALQUER link wa.me | `subject` (cotacao, coleta, rastreamento, outros, unidade; financeiro existiu até 31/08/2026), `option` (região/atendente), `source` (modal, footer, contato), `page` | **Conversão principal** Ads + evento-chave GA4 |
