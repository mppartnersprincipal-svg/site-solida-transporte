...
export const SITE_DESCRIPTION =
  "Transportadora de cargas fracionadas entre São Paulo, Goiás, Distrito Federal e a cidade do Rio de Janeiro. Coleta no prazo e entrega em 2 a 3 dias úteis em capitais e regiões metropolitanas (3 a 4 no interior, com prazo maior em algumas cidades), há 32 anos com o mesmo CNPJ.";
